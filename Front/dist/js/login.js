...
/***/ function(module, exports) {
	...
	var COMMENT_url = window.location.origin;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _loginBox = __webpack_require__(259);
	...
	var Login = function (_Component) {
	    ...
	    _createClass(Login, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement('div', { className: 'login-contain' }, _react2.default.createElement(_row2.default, { className: 'H100' }, _react2.default.createElement(_col2.default, { xs: { span: 12, offset: 6 }, sm: { span: 12, offset: 6 }, md: { span: 4, offset: 10 }, className: 'login-box-layout' }, _react2.default.createElement(_loginBox2.default, null))));
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _cookie = __webpack_require__(260);
	...
	var LoginBox = function (_Component) {
	    ...
	    _createClass(LoginBox, [{
	        ...
	        value: function handleClick() {
	            ...
	            var that = this;
	            _superagent2.default.post(_server2.default.logIn).send({ username: username, password: password }).end(function (err, res) {
	
	                res = JSON.parse(res.text);
	
	                if (res.states == 1) {
	                    _cookie2.default.setCookie("name", res.name, 1);
	
	                    var return_href = window.location.href.split("returnHref=")[1];
	        ...
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement('div', { className: 'loginWrap' }, _react2.default.createElement('p', { className: 'title' }, 'LogIn'), _react2.default.createElement('div', { className: 'loginBox' }, _react2.default.createElement('label', null, '用户名'), _react2.default.createElement('input', { type: 'text', className: 'username', ref: 'username' }), _react2.default.createElement('label', null, '密　码'), _react2.default.createElement('input', { type: 'password', className: 'password', ref: 'password' }), _react2.default.createElement('button', { id: 'loginBtn', onClick: this.handleClick.bind(this) }, '登录')));
	        }
	    }]);
